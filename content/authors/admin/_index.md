...
I am currently working on quantifying individual elements' asymmetries in SNRs other than Cassiopeia A (for which I led a successful Chandra archival project to support) and measuring the mass ratios of Fe-group elements in MW and LMC Type Ia SNRs in order to place constraints on their progenitors through comparison to 3D SNe simulations. In the future, I will make use of the incredibly detailed spectra from microcalorimeters like *XRISM* to study the 3D distribution and make precise measurements of ejecta metals and plasma properties in SNRs.